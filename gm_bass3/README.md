...
| IBASS3Channel:SetVolume()         | ``float Volume``                         | ``nil``                  | **Clientside**<br><br>Set the volume to the given value.<br><br>Volume values:<br>0 = Muted<br>1 = 100% Volume<br> 1+ = Amplified volume (Max: 1000) |
